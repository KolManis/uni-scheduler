...
function Show-Help {
    ...
    Row "db-reset" "Пересоздать пустую БД - ВНИМАНИЕ: удаляет расписания"
    Write-Host ""
...
switch ($Target.ToLower()) {
    ...
    "db-reset" {
        ...
        Write-Host "БД пересоздана пустой. Схему создаст приложение при старте." -ForegroundColor Green
    }
