...
func NewRouter(
	...
	excelHandler *rest.ExcelHandler,
	importHandler *rest.ImportHandler,
	referenceHandler *rest.ReferenceHandler,
	refWriteHandler *rest.RefWriteHandler,
	...
	api.HandleFunc("/input/check", scheduleHandler.CheckInput).Methods(http.MethodGet)
	...
	api.HandleFunc("/schedules/{id:[0-9]+}/replay", scheduleHandler.Replay).Methods(http.MethodPost)
